...
button1 = Button(label2, text = 'ОТМЕНА', bg = 'OrangeRed2', fg = 'gray10', activebackground = 'OrangeRed2', activeforeground = 'gray10')
button2 = Button(label2, text = 'А я зелёненький)', bg = 'green2', fg = 'gray10', activebackground = 'green2', activeforeground = 'gray10')
label1.grid()
label2.grid()
